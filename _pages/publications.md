...
**[19]** **Yansong Gao**, Huming Qiu, Zhi Zhang, Binghui Wang, Hua Ma, Alsharif Abuadbba, Minhui Xue, Anmin Fu, and Surya Nepal. "DeepTheft: Stealing DNN Model Architectures through Power Side Channel", IEEE Symposium on Security and Privacy (**Oakland**), 2024, **CCF A**, [code and large-scale dataset](https://github.com/LearningMaker/DeepTheft)

**[18]** Shaofeng Li, Xinyu Wang, Minhui Xue, Haojin Zhu, Zhi Zhang, **Yansong Gao**, Wen Wu, Xuemin (Sherman) Shen, Yes, One-Bit-Flip Matters! Universal DNN Model Inference Depletion with Runtime Code Fault Injection, USENIX Security Symposium (**Distinguished Paper Award**), 2024, **CCF A**
